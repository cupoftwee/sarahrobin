<template>
  <footer class="footer-menu bg-white border-t-glass p-10 md:p-16">
    <div class="w-full text-center md:text-left md:w-1/2 mb-4">      
      <g-link to="/" class="footer-logo link-pretty">
    ...
    <div class="w-full px-0 md:w-1/2">
      <nav>
        <ul class="flex flex-wrap justify-around align-center py-4 px-4 mb-4 lg:justify-end lg:px-0">
          <li class="px-2 mb-0">
            <g-link to="/" class="footer-link nav-link link-pretty hover:text-teal-400g">
              <fa-icon icon="home" />
              Home
            </g-link>
          </li>
          ...
          <li class="px-2 mb-0">
            <g-link to="/about/" class="footer-link nav-link link-pretty hover:text-blue-400">
          ...
          <li class="pl-2 mb-0">
            <g-link to="/writing/" class="footer-link nav-link link-pretty hover:text-purple-400">
          ...
          <li class="pl-2 mb-0">
            <a href="#contact" class="footer-link nav-link link-pretty hover:text-purple-400">
 ...
 <style>
    .footer-menu {
      ...
      .footer-logo {
        ...
        @apply font-light text-lg no-underline;
      ...
      .footer-link {
        @apply font-bold transition-color transition-color;
        @apply text-base;
