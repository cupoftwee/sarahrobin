    ...
    <div class="about-bio max-w-sm p-6 lg:px-0 lg:max-w-3xl">
      ...
      <div>
        ...
        <div v-if="teaser" class="mt-12 flex justify-end">
          <g-link to="/about" class="button text-md font-bold border-2 text-pink-500 border-pink-500 rounded-full px-6 py-3 mb-4 hover:no-underline hover:text-white hover:bg-pink-500 transition-bg">
